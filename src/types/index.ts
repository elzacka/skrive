...
export interface I18nStrings {
  ...
  shortcutsSidebar: string;
  navigateShortcut: string;
  openItemShortcut: string;
  ...
  extendSelectionShortcut: string;
  multiSelectHint: string;
  rangeSelectHint: string;
  contextMenuHint: string;
  rightClickLabel: string;
  clickLabel: string;
  renameF2MacHint: string;
  screenGateTitle: string;
  screenGateTouchBody: string;
  screenGateWindowBody: string;
  formatting: string;
  format: string;
  plaintext: string;
  richtext: string;
  ...
  installHintChromium: string;
  installHintSafariMac: string;
  installHintSafariIpad: string;
  autoBackup: string;
